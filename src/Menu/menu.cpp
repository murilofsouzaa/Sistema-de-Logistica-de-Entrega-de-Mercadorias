...
void menuPedidos() {
    ...
    do {
        ...
        cout << "    (Apos a simulacao da entrega, o status do veiculo sera alterado para 'disponivel' e o local atualizado para o destino do pedido)\n";
        cout << "0 - Voltar ao menu principal\n";
        cout << "Escolha: ";
        cin >> opcao;
        ...
        switch (opcao) {
            ...
            case 6:
                ...
                cout << "Apos a entrega, o status do veiculo sera 'disponivel' e o local atualizado para o destino do pedido.\n";
                break;
        }
    } while (opcao != 0);
}
